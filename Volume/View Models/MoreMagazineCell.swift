...
/// `MoreMagazineRow` displays the basis information about a publications the user is not currently following
struct MoreMagazineCell: View {
...
//struct MoreMagazineRow_Previews: PreviewProvider {
