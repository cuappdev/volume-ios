...
extension OrgsLoginView {
    ...
    class ViewModel: ObservableObject {
        ...
        func authenticate(accessCode: String, slug: String) async {
            ...
            Network.client.queryPublisher(query: VolumeAPI.CheckAccessCodeQuery(accessCode: accessCode, slug: slug))
                .compactMap { $0.data?.organization?.fragments.organizationFields }
